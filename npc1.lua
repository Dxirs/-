...
--if distanceBetween(npc.x+38,npc.y,player.body:getX(),player.body:getY()) > 90 then
--  kg = 1
--end
...
--end
--end
--if distanceBetween(npc.x+38,npc.y,player_1.body1:getX(),player_1.body1:getY()) > 90 then
--  ki = 1
--end
